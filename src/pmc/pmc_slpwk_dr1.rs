#[doc = "Writer for register PMC_SLPWK_DR1"]
pub type W = crate::W<u32, super::PMC_SLPWK_DR1>;
#[doc = "Register PMC_SLPWK_DR1 `reset()`'s with value 0"]
impl crate::ResetValue for super::PMC_SLPWK_DR1 {
    type Type = u32;
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 30 - Peripheral 62 SleepWalking Disable"]
    #[inline(always)]
